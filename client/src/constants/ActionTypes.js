...
export default {
  ...
  FINANCE_CONFIG_FETCH: 'FINANCE_CONFIG_FETCH',
  FINANCE_CONFIG_FETCH__SUCCESS: 'FINANCE_CONFIG_FETCH__SUCCESS',
  FINANCE_CONFIG_FETCH__FAILURE: 'FINANCE_CONFIG_FETCH__FAILURE',

  FINANCE_CONFIG_UPDATE: 'FINANCE_CONFIG_UPDATE',
  FINANCE_CONFIG_UPDATE__SUCCESS: 'FINANCE_CONFIG_UPDATE__SUCCESS',
  FINANCE_CONFIG_UPDATE__FAILURE: 'FINANCE_CONFIG_UPDATE__FAILURE',

  FINANCE_MEMBER_ADD: 'FINANCE_MEMBER_ADD',
  FINANCE_MEMBER_ADD__SUCCESS: 'FINANCE_MEMBER_ADD__SUCCESS',
  FINANCE_MEMBER_ADD__FAILURE: 'FINANCE_MEMBER_ADD__FAILURE',

  FINANCE_MEMBER_REMOVE: 'FINANCE_MEMBER_REMOVE',
  FINANCE_MEMBER_REMOVE__SUCCESS: 'FINANCE_MEMBER_REMOVE__SUCCESS',
  FINANCE_MEMBER_REMOVE__FAILURE: 'FINANCE_MEMBER_REMOVE__FAILURE',

  EXPENSES_FETCH: 'EXPENSES_FETCH',
  EXPENSES_FETCH__SUCCESS: 'EXPENSES_FETCH__SUCCESS',
  EXPENSES_FETCH__FAILURE: 'EXPENSES_FETCH__FAILURE',

  EXPENSE_CREATE: 'EXPENSE_CREATE',
  EXPENSE_CREATE__SUCCESS: 'EXPENSE_CREATE__SUCCESS',
  EXPENSE_CREATE__FAILURE: 'EXPENSE_CREATE__FAILURE',

  EXPENSE_CREATE_WITH_ATTACHMENTS: 'EXPENSE_CREATE_WITH_ATTACHMENTS',

  EXPENSE_UPDATE: 'EXPENSE_UPDATE',
  EXPENSE_UPDATE__SUCCESS: 'EXPENSE_UPDATE__SUCCESS',
  EXPENSE_UPDATE__FAILURE: 'EXPENSE_UPDATE__FAILURE',

  EXPENSE_DELETE: 'EXPENSE_DELETE',
  EXPENSE_DELETE__SUCCESS: 'EXPENSE_DELETE__SUCCESS',
  EXPENSE_DELETE__FAILURE: 'EXPENSE_DELETE__FAILURE',

  EXPENSE_STATS_FETCH: 'EXPENSE_STATS_FETCH',
  EXPENSE_STATS_FETCH__SUCCESS: 'EXPENSE_STATS_FETCH__SUCCESS',
  EXPENSE_STATS_FETCH__FAILURE: 'EXPENSE_STATS_FETCH__FAILURE',

  /* Expense Attachments */

  EXPENSE_ATTACHMENTS_FETCH: 'EXPENSE_ATTACHMENTS_FETCH',
  EXPENSE_ATTACHMENTS_FETCH__SUCCESS: 'EXPENSE_ATTACHMENTS_FETCH__SUCCESS',
  EXPENSE_ATTACHMENTS_FETCH__FAILURE: 'EXPENSE_ATTACHMENTS_FETCH__FAILURE',

  EXPENSE_ATTACHMENT_CREATE: 'EXPENSE_ATTACHMENT_CREATE',
  EXPENSE_ATTACHMENT_CREATE__SUCCESS: 'EXPENSE_ATTACHMENT_CREATE__SUCCESS',
  EXPENSE_ATTACHMENT_CREATE__FAILURE: 'EXPENSE_ATTACHMENT_CREATE__FAILURE',

  EXPENSE_ATTACHMENT_DELETE: 'EXPENSE_ATTACHMENT_DELETE',
  EXPENSE_ATTACHMENT_DELETE__SUCCESS: 'EXPENSE_ATTACHMENT_DELETE__SUCCESS',
  EXPENSE_ATTACHMENT_DELETE__FAILURE: 'EXPENSE_ATTACHMENT_DELETE__FAILURE',
};

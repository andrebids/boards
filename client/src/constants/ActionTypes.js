...
export default {
  ...
  USER_WELCOME_EMAIL_RESEND: 'USER_WELCOME_EMAIL_RESEND',
  USER_WELCOME_EMAIL_RESEND__SUCCESS: 'USER_WELCOME_EMAIL_RESEND__SUCCESS',
  USER_WELCOME_EMAIL_RESEND__FAILURE: 'USER_WELCOME_EMAIL_RESEND__FAILURE',
  ...
  USER_PRESENCE_UPDATE_HANDLE: 'USER_PRESENCE_UPDATE_HANDLE',
  ...
  PROJECTS_GRID_STYLE_UPDATE: 'PROJECTS_GRID_STYLE_UPDATE',
  ...
  MEDIA_TYPE_FILTER_IN_BOARD_UPDATE: 'MEDIA_TYPE_FILTER_IN_BOARD_UPDATE',
  ...
  CHAT_INBOX_FETCH: 'CHAT_INBOX_FETCH',
  CHAT_INBOX_FETCH__SUCCESS: 'CHAT_INBOX_FETCH__SUCCESS',
  CHAT_INBOX_FETCH__FAILURE: 'CHAT_INBOX_FETCH__FAILURE',
  CHAT_INBOX_READ: 'CHAT_INBOX_READ',
  CHAT_INBOX_READ__SUCCESS: 'CHAT_INBOX_READ__SUCCESS',
  CHAT_INBOX_READ__FAILURE: 'CHAT_INBOX_READ__FAILURE',
  CHAT_INBOX_ITEM_UPDATE_HANDLE: 'CHAT_INBOX_ITEM_UPDATE_HANDLE',
  CHAT_MEMBERS_FETCH: 'CHAT_MEMBERS_FETCH',
  CHAT_MEMBERS_FETCH__SUCCESS: 'CHAT_MEMBERS_FETCH__SUCCESS',
  CHAT_MEMBERS_FETCH__FAILURE: 'CHAT_MEMBERS_FETCH__FAILURE',
  CHAT_CONVERSATIONS_FETCH: 'CHAT_CONVERSATIONS_FETCH',
  CHAT_CONVERSATIONS_FETCH__SUCCESS: 'CHAT_CONVERSATIONS_FETCH__SUCCESS',
  CHAT_CONVERSATIONS_FETCH__FAILURE: 'CHAT_CONVERSATIONS_FETCH__FAILURE',
  CHAT_CONVERSATION_CREATE: 'CHAT_CONVERSATION_CREATE',
  CHAT_CONVERSATION_CREATE__SUCCESS: 'CHAT_CONVERSATION_CREATE__SUCCESS',
  CHAT_CONVERSATION_CREATE__FAILURE: 'CHAT_CONVERSATION_CREATE__FAILURE',
  CHAT_CONVERSATION_CREATE_HANDLE: 'CHAT_CONVERSATION_CREATE_HANDLE',
  CHAT_CONVERSATION_UPDATE_HANDLE: 'CHAT_CONVERSATION_UPDATE_HANDLE',
  CHAT_CONVERSATION_UPDATE: 'CHAT_CONVERSATION_UPDATE',
  CHAT_CONVERSATION_UPDATE__SUCCESS: 'CHAT_CONVERSATION_UPDATE__SUCCESS',
  CHAT_CONVERSATION_UPDATE__FAILURE: 'CHAT_CONVERSATION_UPDATE__FAILURE',
  CHAT_CONVERSATION_OPEN: 'CHAT_CONVERSATION_OPEN',
  CHAT_CONVERSATION_CLOSE: 'CHAT_CONVERSATION_CLOSE',
  CHAT_CONVERSATION_MINIMIZED_TOGGLE: 'CHAT_CONVERSATION_MINIMIZED_TOGGLE',
  CHAT_MESSAGES_FETCH: 'CHAT_MESSAGES_FETCH',
  CHAT_MESSAGES_FETCH__SUCCESS: 'CHAT_MESSAGES_FETCH__SUCCESS',
  CHAT_MESSAGES_FETCH__FAILURE: 'CHAT_MESSAGES_FETCH__FAILURE',
  CHAT_MESSAGE_CREATE: 'CHAT_MESSAGE_CREATE',
  CHAT_MESSAGE_CREATE__SUCCESS: 'CHAT_MESSAGE_CREATE__SUCCESS',
  CHAT_MESSAGE_CREATE__FAILURE: 'CHAT_MESSAGE_CREATE__FAILURE',
  CHAT_MESSAGE_CREATE_HANDLE: 'CHAT_MESSAGE_CREATE_HANDLE',
  CHAT_MESSAGE_ATTACHMENT_CREATE_HANDLE: 'CHAT_MESSAGE_ATTACHMENT_CREATE_HANDLE',
  CHAT_MESSAGE_ATTACHMENT_UPLOAD__FAILURE: 'CHAT_MESSAGE_ATTACHMENT_UPLOAD__FAILURE',
  CHAT_MESSAGE_ATTACHMENT_RETRY: 'CHAT_MESSAGE_ATTACHMENT_RETRY',
  CHAT_MESSAGE_RETRY: 'CHAT_MESSAGE_RETRY',
  CHAT_MESSAGE_UPDATE: 'CHAT_MESSAGE_UPDATE',
  CHAT_MESSAGE_UPDATE__SUCCESS: 'CHAT_MESSAGE_UPDATE__SUCCESS',
  CHAT_MESSAGE_UPDATE__FAILURE: 'CHAT_MESSAGE_UPDATE__FAILURE',
  CHAT_MESSAGE_UPDATE_HANDLE: 'CHAT_MESSAGE_UPDATE_HANDLE',
  CHAT_MESSAGE_DELETE: 'CHAT_MESSAGE_DELETE',
  CHAT_MESSAGE_DELETE__SUCCESS: 'CHAT_MESSAGE_DELETE__SUCCESS',
  CHAT_MESSAGE_DELETE__FAILURE: 'CHAT_MESSAGE_DELETE__FAILURE',
  CHAT_MESSAGE_DELETE_HANDLE: 'CHAT_MESSAGE_DELETE_HANDLE',
  CHAT_MESSAGE_REACTION_TOGGLE: 'CHAT_MESSAGE_REACTION_TOGGLE',
  CHAT_CONVERSATION_READ: 'CHAT_CONVERSATION_READ',
  CHAT_CONVERSATION_READ__SUCCESS: 'CHAT_CONVERSATION_READ__SUCCESS',
  CHAT_CONVERSATION_READ__FAILURE: 'CHAT_CONVERSATION_READ__FAILURE',
  CHAT_CONVERSATION_READ_HANDLE: 'CHAT_CONVERSATION_READ_HANDLE',
  CHAT_CONVERSATION_HISTORY_CLEAR: 'CHAT_CONVERSATION_HISTORY_CLEAR',
  CHAT_CONVERSATION_HISTORY_CLEAR__SUCCESS: 'CHAT_CONVERSATION_HISTORY_CLEAR__SUCCESS',
  CHAT_CONVERSATION_HISTORY_CLEAR__FAILURE: 'CHAT_CONVERSATION_HISTORY_CLEAR__FAILURE',
  CHAT_CONVERSATION_HISTORY_CLEAR_HANDLE: 'CHAT_CONVERSATION_HISTORY_CLEAR_HANDLE',
  CHAT_PROJECT_ACCESS_REVOKE_HANDLE: 'CHAT_PROJECT_ACCESS_REVOKE_HANDLE',
  CHAT_CONVERSATION_ACCESS_REVOKE_HANDLE: 'CHAT_CONVERSATION_ACCESS_REVOKE_HANDLE',
  CHAT_PARTICIPANT_UPDATE_HANDLE: 'CHAT_PARTICIPANT_UPDATE_HANDLE',
  CHAT_TYPING_UPDATE_HANDLE: 'CHAT_TYPING_UPDATE_HANDLE',
  CHAT_MESSAGE_ALERT_HANDLE: 'CHAT_MESSAGE_ALERT_HANDLE',
  CHAT_CONVERSATION_PREFERENCES_UPDATE: 'CHAT_CONVERSATION_PREFERENCES_UPDATE',
  CHAT_CONVERSATION_PREFERENCES_UPDATE__SUCCESS: 'CHAT_CONVERSATION_PREFERENCES_UPDATE__SUCCESS',
  CHAT_CONVERSATION_PREFERENCES_UPDATE__FAILURE: 'CHAT_CONVERSATION_PREFERENCES_UPDATE__FAILURE',
  CHAT_DRAFT_UPDATE: 'CHAT_DRAFT_UPDATE',
  CHAT_REPLY_TARGET_SET: 'CHAT_REPLY_TARGET_SET',
  ...
  NOTIFICATION_HISTORY_FETCH: 'NOTIFICATION_HISTORY_FETCH',
  NOTIFICATION_HISTORY_FETCH__SUCCESS: 'NOTIFICATION_HISTORY_FETCH__SUCCESS',
  NOTIFICATION_HISTORY_FETCH__FAILURE: 'NOTIFICATION_HISTORY_FETCH__FAILURE',
  ...
  ORGANIZATION_DEFAULT_LABELS_BULK_APPLY__SUCCESS:
    'ORGANIZATION_DEFAULT_LABELS_BULK_APPLY__SUCCESS',
};

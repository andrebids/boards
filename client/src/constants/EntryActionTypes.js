...
export default {
  ...
  CARD_USER_ADD: `${PREFIX}/CARD_USER_ADD`,
  CARD_LABEL_ADD: `${PREFIX}/CARD_LABEL_ADD`,
  CURRENT_CARD_DELETE: `${PREFIX}/CURRENT_CARD_DELETE`,
  CARD_DELETE_HANDLE: `${PREFIX}/CARD_DELETE_HANDLE`,
  ADD_USER_TO_CURRENT_CARD: `${PREFIX}/ADD_USER_TO_CURRENT_CARD`,
  ADD_LABEL_TO_CURRENT_CARD: `${PREFIX}/ADD_LABEL_TO_CURRENT_CARD`,

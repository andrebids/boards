...
export default {
  ...
  USER_WELCOME_EMAIL_RESEND: `${PREFIX}/USER_WELCOME_EMAIL_RESEND`,
  USER_UPDATE: `${PREFIX}/USER_UPDATE`,
  CURRENT_USER_UPDATE: `${PREFIX}/CURRENT_USER_UPDATE`,
  USER_UPDATE_HANDLE: `${PREFIX}/USER_UPDATE_HANDLE`,
  USER_PRESENCE_UPDATE_HANDLE: `${PREFIX}/USER_PRESENCE_UPDATE_HANDLE`,
  ...
  PROJECT_ARCHIVE_UPDATE: `${PREFIX}/PROJECT_ARCHIVE_UPDATE`,

  PROJECTS_SEARCH: `${PREFIX}/PROJECTS_SEARCH`,
  PROJECTS_ORDER_UPDATE: `${PREFIX}/PROJECTS_ORDER_UPDATE`,
  PROJECTS_GRID_STYLE_UPDATE: `${PREFIX}/PROJECTS_GRID_STYLE_UPDATE`,
  ...
  MEDIA_TYPE_FILTER_IN_CURRENT_BOARD_UPDATE: `${PREFIX}/MEDIA_TYPE_FILTER_IN_CURRENT_BOARD_UPDATE`,
  ...
  CARD_ATTACHMENT_UPLOAD: `${PREFIX}/CARD_ATTACHMENT_UPLOAD`,
  ...
  ATTACHMENT_CREATE: `${PREFIX}/ATTACHMENT_CREATE`,
  ...
  COMMENT_REACTION_TOGGLE: `${PREFIX}/COMMENT_REACTION_TOGGLE`,
  ...
  CHAT_INBOX_FETCH: `${PREFIX}/CHAT_INBOX_FETCH`,
  CHAT_INBOX_READ: `${PREFIX}/CHAT_INBOX_READ`,
  CHAT_FOR_CURRENT_PROJECT_FETCH: `${PREFIX}/CHAT_FOR_CURRENT_PROJECT_FETCH`,
  CHAT_MEMBERS_FETCH: `${PREFIX}/CHAT_MEMBERS_FETCH`,
  CHAT_CONVERSATIONS_FETCH: `${PREFIX}/CHAT_CONVERSATIONS_FETCH`,
  GENERAL_CHAT_CONVERSATION_CREATE: `${PREFIX}/GENERAL_CHAT_CONVERSATION_CREATE`,
  DIRECT_CHAT_CONVERSATION_CREATE: `${PREFIX}/DIRECT_CHAT_CONVERSATION_CREATE`,
  CUSTOM_CHAT_GROUP_CREATE: `${PREFIX}/CUSTOM_CHAT_GROUP_CREATE`,
  CHAT_CONVERSATION_UPDATE: `${PREFIX}/CHAT_CONVERSATION_UPDATE`,
  CHAT_CONVERSATION_PARTICIPANTS_ADD: `${PREFIX}/CHAT_CONVERSATION_PARTICIPANTS_ADD`,
  CHAT_CONVERSATION_PARTICIPANT_DELETE: `${PREFIX}/CHAT_CONVERSATION_PARTICIPANT_DELETE`,
  CHAT_CONVERSATION_LEAVE: `${PREFIX}/CHAT_CONVERSATION_LEAVE`,
  CHAT_CONVERSATION_PREFERENCES_UPDATE: `${PREFIX}/CHAT_CONVERSATION_PREFERENCES_UPDATE`,
  CHAT_TYPING_UPDATE: `${PREFIX}/CHAT_TYPING_UPDATE`,
  CHAT_CONVERSATION_CREATE_HANDLE: `${PREFIX}/CHAT_CONVERSATION_CREATE_HANDLE`,
  CHAT_CONVERSATION_UPDATE_HANDLE: `${PREFIX}/CHAT_CONVERSATION_UPDATE_HANDLE`,
  CHAT_CONVERSATION_OPEN: `${PREFIX}/CHAT_CONVERSATION_OPEN`,
  CHAT_CONVERSATION_CLOSE: `${PREFIX}/CHAT_CONVERSATION_CLOSE`,
  CHAT_CONVERSATION_MINIMIZED_TOGGLE: `${PREFIX}/CHAT_CONVERSATION_MINIMIZED_TOGGLE`,
  CHAT_MESSAGES_FETCH: `${PREFIX}/CHAT_MESSAGES_FETCH`,
  CHAT_MESSAGE_CREATE: `${PREFIX}/CHAT_MESSAGE_CREATE`,
  CHAT_MESSAGE_RETRY: `${PREFIX}/CHAT_MESSAGE_RETRY`,
  CHAT_MESSAGE_CREATE_HANDLE: `${PREFIX}/CHAT_MESSAGE_CREATE_HANDLE`,
  CHAT_MESSAGE_ATTACHMENT_CREATE_HANDLE: `${PREFIX}/CHAT_MESSAGE_ATTACHMENT_CREATE_HANDLE`,
  CHAT_MESSAGE_ATTACHMENT_RETRY: `${PREFIX}/CHAT_MESSAGE_ATTACHMENT_RETRY`,
  CHAT_MESSAGE_UPDATE: `${PREFIX}/CHAT_MESSAGE_UPDATE`,
  CHAT_MESSAGE_UPDATE_HANDLE: `${PREFIX}/CHAT_MESSAGE_UPDATE_HANDLE`,
  CHAT_MESSAGE_DELETE: `${PREFIX}/CHAT_MESSAGE_DELETE`,
  CHAT_MESSAGE_DELETE_HANDLE: `${PREFIX}/CHAT_MESSAGE_DELETE_HANDLE`,
  CHAT_MESSAGE_REACTION_TOGGLE: `${PREFIX}/CHAT_MESSAGE_REACTION_TOGGLE`,
  CHAT_CONVERSATION_READ: `${PREFIX}/CHAT_CONVERSATION_READ`,
  CHAT_CONVERSATION_READ_HANDLE: `${PREFIX}/CHAT_CONVERSATION_READ_HANDLE`,
  CHAT_CONVERSATION_HISTORY_CLEAR: `${PREFIX}/CHAT_CONVERSATION_HISTORY_CLEAR`,
  CHAT_CONVERSATION_HISTORY_CLEAR_HANDLE: `${PREFIX}/CHAT_CONVERSATION_HISTORY_CLEAR_HANDLE`,
  CHAT_PROJECT_ACCESS_REVOKE_HANDLE: `${PREFIX}/CHAT_PROJECT_ACCESS_REVOKE_HANDLE`,
  CHAT_CONVERSATION_ACCESS_REVOKE_HANDLE: `${PREFIX}/CHAT_CONVERSATION_ACCESS_REVOKE_HANDLE`,
  CHAT_PARTICIPANT_UPDATE_HANDLE: `${PREFIX}/CHAT_PARTICIPANT_UPDATE_HANDLE`,
  CHAT_TYPING_UPDATE_HANDLE: `${PREFIX}/CHAT_TYPING_UPDATE_HANDLE`,
  CHAT_MESSAGE_ALERT_HANDLE: `${PREFIX}/CHAT_MESSAGE_ALERT_HANDLE`,
  CHAT_MESSAGE_FORWARD: `${PREFIX}/CHAT_MESSAGE_FORWARD`,
  CHAT_DRAFT_UPDATE: `${PREFIX}/CHAT_DRAFT_UPDATE`,
  CHAT_REPLY_TARGET_SET: `${PREFIX}/CHAT_REPLY_TARGET_SET`,
  ...
  NOTIFICATION_HISTORY_FETCH: `${PREFIX}/NOTIFICATION_HISTORY_FETCH`,

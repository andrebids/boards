...
export default {
  ...
  translation: {
    common: {
      ...
      bulkCardMembersApplyFailed: "Algumas adições podem ter sido salvas. Tenta novamente para atualizar.",
      ...
      passwordCopyFailed: "Não foi possível copiar. Mostre a senha e copie manualmente.",
      passwordGenerationFailed: "Não foi possível gerar uma senha. Tente novamente.",
      ...
      webPushPromptDescription:
        "Receba uma prévia curta neste dispositivo, mesmo quando o Boards estiver fechado.",
      ...
      presentationImportInvalidFile:
        "Selecione um arquivo PowerPoint (.pptx) válido e compatível.",
      ...
      presentationImportOpenTimedOut:
        "O PowerPoint foi carregado, mas o editor demorou muito para abri-lo. Tente novamente.",
      ...
      presentationMediaEmpty: "Ainda não há imagens nos cartões deste quadro.",

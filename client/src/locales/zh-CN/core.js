...
export default {
  ...
  translation: {
    common: {
      ...
      webPushPromptTitle: '开启聊天通知',
      webPushPromptDescription: '即使 Boards 已关闭，也可在此设备上接收简短预览。',
      webPushPromptActivate: '开启',
      webPushPromptLater: '暂不',
      webPushPromptError: '无法开启通知，请重试。',
      notifications: '通知',

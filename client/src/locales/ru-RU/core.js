...
export default {
  ...
  translation: {
    common: {
      cards: 'Карточки',
      autoAddBoardMembersToCards: 'Добавить участников доски ко всем карточкам',
      autoAddBoardMembersToCardsHint:
        'Применяется к текущим и будущим карточкам на всех досках проекта. Отключение не удаляет уже добавленных участников.',
      ...
      changeTemporaryPassword_title: 'Изменить временный пароль',
      changeTemporaryPasswordDescription:
        'В целях безопасности измените временный пароль, прежде чем продолжить.',
      confirmNewPassword: 'Подтвердите новый пароль',
      passwordsDoNotMatch: 'Пароли не совпадают.',
      temporaryPassword: 'Временный пароль',
      welcomeEmailLanguage: 'Язык приветственного письма',
      userCreatedEmailPending_title: 'Пользователь создан',
      userCreatedButWelcomeEmailFailed:
        'Пользователь создан, но приветственное письмо не удалось отправить.',
      welcomeEmailResendFailed: 'Не удалось повторно отправить письмо. Попробуйте ещё раз.',
      welcomeEmailResentSuccessfully: 'Приветственное письмо успешно отправлено повторно.',
      resendingWelcomeEmail: 'Повторная отправка приветственного письма…',
    ...
    action: {
      ...
      close: 'Закрыть',
      resendWelcomeEmail: 'Отправить приветственное письмо повторно',
      resendWelcomeEmail_title: 'Повторная отправка приветственного письма',
      archive: 'Архив',

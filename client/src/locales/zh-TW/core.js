...
export default {
  ...
  translation: {
    common: {
      cards: '卡片',
      autoAddBoardMembersToCards: '將面板成員加入所有卡片',
      autoAddBoardMembersToCardsHint:
        '適用於此專案中所有面板的目前及未來卡片。關閉後不會移除已加入的成員。',
      ...
      webPushPromptTitle: '開啟聊天通知',
      webPushPromptDescription: '即使 Boards 已關閉，也能在此裝置上接收簡短預覽。',
      webPushPromptActivate: '開啟',
      webPushPromptLater: '稍後',
      webPushPromptError: '無法開啟通知，請再試一次。',
      notifications: '通知',

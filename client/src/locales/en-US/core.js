...
export default {
  ...
  translation: {
    common: {
      transversalTitle: "All boards",
      transversalSettingsHint: "Show cards from this project’s boards in columns with matching list names. Existing board permissions still apply.",
      transversalAccess: "Who can use this view",
      transversalDisabled: "Disabled",
      transversalEveryone: "All project members",
      transversalSelected: "Selected people",
      transversalPeople: "People",
      transversalChoosePeople: "Select project members",
      transversalNobody: "No one has access until you select a person.",
      transversalSaved: "View settings saved.",
      transversalSaveFailed: "Could not save. Check the selected members and try again.",
      transversalLoadFailed: "Could not load the view. Try again.",
      transversalUnavailable: "This view is disabled or you no longer have access.",
      transversalEmptyColumn: "No cards in this column.",
      transversalLoading: "Loading…",
      transversalLoadMore: "Load more",
      transversalBoard: "Board",
      transversalAllBoards: "All boards",
      transversalStage: "Stage",
      transversalAllStages: "All stages",
      transversalRefresh: "Refresh",
      transversalHint: "Lists with the same name appear together. Open a card to work in its original board.",
      transversalEmpty: "No matching lists. Create lists in your boards or change the filters.",
      bulkCardMembersHint: "Add members to this project's existing cards.",
      bulkCardMembersLabel: "Project members",
      bulkCardMembersPlaceholder: "Select members",
      bulkCardMembersNoUsers: "No active project members found.",
      bulkCardMembersIncludeArchived: "Include archived cards",
      bulkCardMembersApply: "Add",
      bulkCardMembersPreview: "Cards: {{cardsTotal}} · Boards: {{boardsTotal}} · New: {{additionsTotal}}",
      bulkCardMembersExisting: "Already assigned: {{existingTotal}}",
      bulkCardMembersMissingAccess: "Add these members to these boards first:",
      bulkCardMembersCannotEdit: "Editor access required: {{boards}}.",
      bulkCardMembersResult: "Added: {{addedTotal}}.",
      bulkCardMembersPartialFailure: "Incomplete: {{failedTotal}}. Retry to refresh.",
      bulkCardMembersLoadFailed: "Could not load members. Retry.",
      bulkCardMembersPreviewFailed: "Could not load preview. Retry.",
      bulkCardMembersApplyFailed: "Some additions may have been saved. Retry to refresh.",
      bulkCardMembersChanged: "A member is no longer available. Reopen settings.",
      bulkCardMembersLimit: "Select up to 100 members.",
      bulkCardMembersDisableAutomatic: "Turn off automatic membership to select specific members. Existing memberships are kept.",
      projectArchive: "Archive",
      archiveProject: "Archive project",
      archivingProject: "Archiving…",
      restoreProject: "Restore project",
      restoreProjectNamed: "Restore project “{{name}}”",
      projectArchiveHint: "Remove this project from the main list and favorites. All boards and their contents are kept. Members can still access and edit them according to their permissions.",
      projectIsArchived: "This project is archived.",
      archivedProjectBadge: "Archived",
      archiveProjectConfirmTitle: "Archive this project?",
      archiveProjectConfirm: "“{{name}}” will be archived for all members. All boards and their contents are kept and remain accessible with existing permissions. You can restore the project later.",
      projectArchivedSuccess: "Project archived. Find it in “View archived projects”.",
      projectRestoredSuccess: "Project restored.",
      projectRestoredHidden: "Project restored. It remains hidden.",
      projectArchiveFailed: "Could not update the project archive. Please try again.",
      archivedProjects: "Archived projects",
      viewArchivedProjects: "View archived projects",
      searchArchivedProjects: "Search archived projects…",
      noArchivedProjects: "No archived projects",
      noArchivedProjectsMatch: "No projects match your search",
      projectRestoreManagerRequired: "A project manager is required to restore this project.",
      openArchivedProject: "Open",
      openArchivedProjectNamed: "Open project “{{name}}”",
      ...
      noAttachmentsToDisplay: "No attachments to display",
      openAttachment: "Open",
      ...
      gridProjects: "Overview",
      groupedProjects: "Grouped view",
      ...
      emptyAttachmentFile:
        "{{name}} was not uploaded because the file is empty.",
      ...
      enterSubtaskDescription: "Enter subtask description...",
      ...
      unreadProjectNotifications_one:
        "{{count}} unread notification in this project",
      unreadProjectNotifications_other:
        "{{count}} unread notifications in this project",
      ...
      ganttPeopleHint:
        "People are selected from the current members of this project.",
      ...
      ganttListDrop_before: "Task before {{task}} · {{start}} – {{end}}",
      ganttListDrop_after: "Task after {{task}} · {{start}} – {{end}}",
      ganttListDrop_child: "Subtask of {{task}} · {{start}} – {{end}}",
      ganttListDrop_root: "Task at main level · {{start}} – {{end}}",
      ganttRowDrag_order: "Reorder at this level",
      ganttRowDrag_child: "Subtask of {{parent}}",
      ganttRowDrag_outdent: "Move up to {{parent}}",
      ganttRowDrag_invalid: "Cannot move to this level",
      ganttRowDrag_root: "the main level",
      ganttRowMoveHelp: "{{task}} — Drag up/down to reorder, move sideways and release to change level. Esc to cancel. Keyboard: Alt + arrow keys.",
      ganttEmptyTitle: "This Gantt has no tasks yet",
      ganttEmptyDescription:
        "Create a task with dates or leave it unscheduled.",
      ...
      ganttDatesFromSubtasks: "Dates are calculated from the scheduled subtasks.",
      ganttSearchParents: "Search projects or tasks…",
      ganttParentTask: "Belongs to",
      ganttNoParentsFound: "No eligible parent tasks found",
      ganttInvalidHierarchy: "Choose a valid parent. A task can have one level of subtasks.",
      ganttDeleteBranchConfirmation_one: "Delete this item and its subtask from the Gantt?",
      ganttDeleteBranchConfirmation_other: "Delete this item and all {{count}} subtasks from the Gantt?",
      ...
      ganttDependenciesHint:
        "The dependency is visual and does not change dates automatically.",
      ganttWeekShort: "W",
      ...
      presentationsDescription:
        "One independent collaborative presentation for each board.",
      presentationsByBoard: "Presentations by board",
      presentationsLoadFailed: "Presentations could not be loaded.",
      presentationCreated: "Presentation created",
      presentationNotCreated: "Presentation not created yet",
      presentationNotCreatedForBoard:
        "There is no presentation for {{board}} yet",
      presentationCreateDescription:
        "Create a collaborative PowerPoint linked exclusively to this board.",
      presentationManagerRequired:
        "A project manager must create the presentation.",
      ...
      presentationImportInvalidFile: "Select a valid, supported PowerPoint (.pptx) file.",
      ...
      presentationImportFileTooLarge:
        "This PowerPoint exceeds the {{size}} MB limit and cannot be imported.",
      presentationImportOpenTimedOut:
        "The PowerPoint was uploaded, but the editor took too long to open it. Try again.",
      ...
      presentationMediaUpload: "Upload from computer",
      presentationMediaLoadError: "This image could not be loaded. Try again.",
      ...
      ganttDurationHelp: "Business days, Monday to Friday. 1 week = 5 business days.",
      ganttCalculatedDuration_one: "{{count}} business day",
      ganttCalculatedDuration_other: "{{count}} business days",
      ganttClearSchedule: "Remove schedule",
      ganttDragToSchedule: "Drag onto a date or the task list to schedule",
      ganttScheduling: "Saving schedule…",
      ganttDropPreview: "{{start}} – {{end}} · {{count}} business days",
      ganttTimeScheduling: "Time / Scheduling",
      ganttEstimateDuration: "Estimate duration",
      ganttScheduleDates: "Schedule dates",
      ganttDuration: "Duration",
      ...
      ganttUnscheduledHint: "Set a start date or drag the task onto the Gantt to schedule it.",
      ganttShowAdvancedOptions: "Show more options",
      ganttHideAdvancedOptions: "Hide advanced options",
      ...
      ganttTaskConflict:
        "This task was changed by someone else. Reopen it and try again.",
      ...
      ganttDeleteGeneralTaskConfirmation_one:
        "Delete this project and its task?",
      ...
      ganttEditSourceFieldsInCard:
        "Edit name, member and completion in the card.",
      ...
      selectView_title: "Select View",
      selectGridStyle_title: "Select Grid Style",
      ...
      userReactedToYourCommentOnCard:
        "<0>{{user}}</0> reacted {{emoji}} to your comment on <2>{{card}}</2>",
      ...
      noSavedFilters:
        'No saved filters yet — build one and click "Save".',

...
export default {
  ...
  translation: {
    common: {
      ...
      presentationsDescription: 'One independent collaborative presentation for each board.',
      ...
      presentationNotCreatedForBoard: 'There is no presentation for {{board}} yet',
      presentationCreateDescription:
        'Create a collaborative PowerPoint linked exclusively to this board.',
      presentationManagerRequired: 'A project manager must create the presentation.',

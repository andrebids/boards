...
export default {
  ...
  translation: {
    common: {
      transversalTitle: "Todos los tableros",
      transversalSettingsHint: "Muestra las tarjetas de este proyecto en columnas agrupadas por nombre de lista. Se mantienen los permisos de cada tablero.",
      transversalAccess: "Quién puede usar esta vista",
      transversalDisabled: "Desactivada",
      transversalEveryone: "Todos los miembros del proyecto",
      transversalSelected: "Personas seleccionadas",
      transversalPeople: "Personas",
      transversalChoosePeople: "Seleccionar miembros del proyecto",
      transversalNobody: "Nadie tiene acceso hasta seleccionar una persona.",
      transversalSaved: "Configuración de la vista guardada.",
      transversalSaveFailed: "No se pudo guardar. Revisa los miembros seleccionados e inténtalo de nuevo.",
      transversalLoadFailed: "No se pudo cargar la vista. Inténtalo de nuevo.",
      transversalUnavailable: "Esta vista está desactivada o ya no tienes acceso.",
      transversalEmptyColumn: "No hay tarjetas en esta columna.",
      transversalLoading: "Cargando…",
      transversalLoadMore: "Cargar más",
      transversalBoard: "Tablero",
      transversalAllBoards: "Todos los tableros",
      transversalStage: "Etapa",
      transversalAllStages: "Todas las etapas",
      transversalRefresh: "Actualizar",
      transversalHint: "Las listas con el mismo nombre aparecen juntas. Abre una tarjeta para trabajar en su tablero original.",
      transversalEmpty: "No hay listas coincidentes. Crea listas en los tableros o cambia los filtros.",
      projectArchive: "Archivo",
      archiveProject: "Archivar proyecto",
      archivingProject: "Archivando…",
      restoreProject: "Restaurar proyecto",
      restoreProjectNamed: "Restaurar proyecto “{{name}}”",
      projectArchiveHint: "Retira este proyecto de la lista principal y de los favoritos. Se conservan todos los tableros y su contenido. Los miembros pueden seguir accediendo y editando según sus permisos.",
      projectIsArchived: "Este proyecto está archivado.",
      archivedProjectBadge: "Archivado",
      archiveProjectConfirmTitle: "¿Archivar este proyecto?",
      archiveProjectConfirm: "“{{name}}” se archivará para todos los miembros. Todos los tableros y su contenido se conservan y siguen accesibles con los permisos actuales. Puedes restaurar el proyecto más tarde.",
      projectArchivedSuccess: "Proyecto archivado. Encuéntralo en “Ver proyectos archivados”.",
      projectRestoredSuccess: "Proyecto restaurado.",
      projectRestoredHidden: "Proyecto restaurado. Sigue oculto.",
      projectArchiveFailed: "No se pudo actualizar el archivo del proyecto. Inténtalo de nuevo.",
      archivedProjects: "Proyectos archivados",
      viewArchivedProjects: "Ver proyectos archivados",
      searchArchivedProjects: "Buscar proyectos archivados…",
      noArchivedProjects: "No hay proyectos archivados",
      noArchivedProjectsMatch: "Ningún proyecto coincide con la búsqueda",
      projectRestoreManagerRequired: "Se necesita un gestor del proyecto para restaurarlo.",
      openArchivedProject: "Abrir",
      openArchivedProjectNamed: "Abrir proyecto “{{name}}”",
      cards: 'Tarjetas',
      ...
      noAttachmentsToDisplay: 'No hay archivos adjuntos para mostrar',
      ...
      canCreateUsersAndOwnProjects: 'Puede crear usuarios y proyectos propios, y ser invitado a trabajar en otros proyectos.',
      ...
      changeTemporaryPassword_title: 'Cambiar contraseña temporal',
      ...
      welcomeEmailLanguage: 'Idioma del correo de bienvenida',
    ...
    action: {
      ...
      close: 'Cerrar',
      resendWelcomeEmail: 'Reenviar correo de bienvenida',
      resendWelcomeEmail_title: 'Reenviar correo de bienvenida',
      archive: 'Archivar',

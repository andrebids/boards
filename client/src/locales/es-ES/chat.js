export default {
  translation: {
    chat: {
      ...
      saving: 'Guardando…',
      groupNameSaved: 'Nombre del grupo guardado.',
      groupNameSaveFailed: 'No se pudo guardar el nombre. Inténtalo de nuevo.',
      ...
      failedRetryWithReason: 'Error: {{reason}} · intentar de nuevo',
      ...
      removeConversationHistory: 'Eliminar historial',
      removeConversationHistoryFailed: 'No se pudo eliminar el historial. Inténtalo de nuevo.',
      reply: 'Responder',
      replyingTo: 'Respondiendo a {{name}}',
      restore: 'Restaurar',
      retry: 'Intentar de nuevo',
      save: 'Guardar',
      searchAllConversations: 'Buscar conversaciones y personas...',
      people: 'Personas',
      startConversationWith: 'Iniciar una conversación con {{name}} en {{project}}',
      searchConversations: 'Buscar conversaciones...',
      searchEmoji: 'Buscar emoji',
      searchGroupMembers: 'Buscar personas para el grupo...',
      searchMembers: 'Buscar miembros...',
      searchConversationsAndMembers: 'Buscar conversaciones y miembros...',
      ...
      attachmentUploading: 'Subiendo archivo adjunto…',
      attachmentConfirming: 'Confirmando archivo adjunto…',
      attachmentFailed: 'No se pudo subir el archivo adjunto.',
      psdAttachmentTooLarge: 'Los archivos PSD no pueden superar los {{size}} MB.',
      videoAttachmentTooLarge: 'Los vídeos no pueden superar los {{size}} MB.',
      uploadFailed: 'No se pudo subir el archivo.',
      uploadNetworkError: 'Se perdió la conexión al subir el archivo.',
      uploadTimedOut: 'El envío del archivo tardó demasiado.',

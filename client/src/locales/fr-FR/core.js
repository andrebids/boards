...
export default merge({}, enUSCore, {
  ...
  translation: {
    common: {
      ...
      presentationsDescription: 'Une présentation collaborative indépendante pour chaque tableau.',
      ...
      presentationNotCreatedForBoard: 'Il n’existe pas encore de présentation pour {{board}}',
      ...
      ganttSourceTasksLoadFailed: 'Impossible de charger les tâches des tableaux.',
      ...
      ganttEditSourceFieldsInCard: 'Modifiez le nom, le membre et l’état dans la carte.',

...
export default merge({}, enUSCore, {
  ...
  translation: {
    common: {
      transversalTitle: "Tous les tableaux",
      transversalSettingsHint: "Affiche les cartes des tableaux de ce projet dans des colonnes regroupées par nom de liste. Les permissions des tableaux restent applicables.",
      transversalAccess: "Qui peut utiliser cette vue",
      transversalDisabled: "Désactivée",
      transversalEveryone: "Tous les membres du projet",
      transversalSelected: "Personnes sélectionnées",
      transversalPeople: "Personnes",
      transversalChoosePeople: "Sélectionner des membres du projet",
      transversalNobody: "Personne n’a accès tant qu’aucune personne n’est sélectionnée.",
      transversalSaved: "Paramètres de la vue enregistrés.",
      transversalSaveFailed: "Enregistrement impossible. Vérifiez les membres sélectionnés et réessayez.",
      transversalLoadFailed: "Impossible de charger la vue. Réessayez.",
      transversalUnavailable: "Cette vue est désactivée ou vous n’y avez plus accès.",
      transversalEmptyColumn: "Aucune carte dans cette colonne.",
      transversalLoading: "Chargement…",
      transversalLoadMore: "Charger plus",
      transversalBoard: "Tableau",
      transversalAllBoards: "Tous les tableaux",
      transversalStage: "Étape",
      transversalAllStages: "Toutes les étapes",
      transversalRefresh: "Actualiser",
      transversalHint: "Les listes portant le même nom sont regroupées. Ouvrez une carte pour travailler dans son tableau d’origine.",
      transversalEmpty: "Aucune liste correspondante. Créez des listes dans vos tableaux ou modifiez les filtres.",
      bulkCardMembersHint: "Ajouter des membres aux cartes existantes du projet.",
      bulkCardMembersLabel: "Membres du projet",
      bulkCardMembersPlaceholder: "Sélectionner des membres",
      bulkCardMembersNoUsers: "Aucun membre actif dans ce projet.",
      bulkCardMembersIncludeArchived: "Inclure les cartes archivées",
      bulkCardMembersApply: "Ajouter",
      bulkCardMembersPreview: "Cartes : {{cardsTotal}} · Tableaux : {{boardsTotal}} · Ajouts : {{additionsTotal}}",
      bulkCardMembersExisting: "Déjà associés : {{existingTotal}}",
      bulkCardMembersMissingAccess: "Ajoutez d’abord ces membres aux tableaux indiqués :",
      bulkCardMembersCannotEdit: "Accès éditeur requis : {{boards}}.",
      bulkCardMembersResult: "Ajouts effectués : {{addedTotal}}.",
      bulkCardMembersPartialFailure: "Incomplets : {{failedTotal}}. Réessayez pour actualiser.",
      bulkCardMembersLoadFailed: "Impossible de charger les membres. Réessayez.",
      bulkCardMembersPreviewFailed: "Impossible de charger l’aperçu. Réessayez.",
      bulkCardMembersApplyFailed: "Certains ajouts peuvent être enregistrés. Réessayez pour actualiser.",
      bulkCardMembersChanged: "Un membre n’est plus disponible. Rouvrez les paramètres.",
      bulkCardMembersLimit: "Sélectionnez jusqu’à 100 membres.",
      bulkCardMembersDisableAutomatic: "Désactivez l’ajout automatique pour choisir des membres. Les associations existantes sont conservées.",
      userManager: "Gestionnaire des utilisateurs",
      canCreateUsersAndOwnProjects: "Peut créer des utilisateurs et ses propres projets, et être invité à travailler dans d’autres projets.",
      projectArchive: "Archivage",
      archiveProject: "Archiver le projet",
      archivingProject: "Archivage…",
      restoreProject: "Restaurer le projet",
      restoreProjectNamed: "Restaurer le projet « {{name}} »",
      projectArchiveHint: "Retire ce projet de la liste principale et des favoris. Tous les tableaux et leur contenu sont conservés. Les membres peuvent continuer à y accéder et à les modifier selon leurs permissions.",
      projectIsArchived: "Ce projet est archivé.",
      archivedProjectBadge: "Archivé",
      archiveProjectConfirmTitle: "Archiver ce projet ?",
      archiveProjectConfirm: "« {{name}} » sera archivé pour tous les membres. Tous les tableaux et leur contenu sont conservés et restent accessibles avec les permissions actuelles. Vous pourrez restaurer le projet plus tard.",
      projectArchivedSuccess: "Projet archivé. Retrouvez-le dans « Voir les projets archivés ».",
      projectRestoredSuccess: "Projet restauré.",
      projectRestoredHidden: "Projet restauré. Il reste masqué.",
      projectArchiveFailed: "Impossible de modifier l’archivage du projet. Réessayez.",
      archivedProjects: "Projets archivés",
      viewArchivedProjects: "Voir les projets archivés",
      searchArchivedProjects: "Rechercher des projets archivés…",
      noArchivedProjects: "Aucun projet archivé",
      noArchivedProjectsMatch: "Aucun projet ne correspond à votre recherche",
      projectRestoreManagerRequired: "Un gestionnaire du projet est nécessaire pour le restaurer.",
      openArchivedProject: "Ouvrir",
      openArchivedProjectNamed: "Ouvrir le projet « {{name}} »",
      cards: "Cartes",
      autoAddBoardMembersToCards:
        "Ajouter les membres du tableau à toutes les cartes",
      ...
      noAttachmentsToDisplay: "Aucune pièce jointe à afficher",
      ...
      ganttPeopleHint:
        "Les personnes sont sélectionnées parmi les membres actuels de ce projet.",
      ...
      ganttEmptyDescription:
        "Créez une tâche avec des dates ou laissez-la non planifiée.",
      ...
      presentationsDescription:
        "Une présentation collaborative indépendante pour chaque tableau.",
      presentationsByBoard: "Présentations par tableau",
      presentationsLoadFailed: "Impossible de charger les présentations.",
      presentationCreated: "Présentation créée",
      presentationNotCreated: "Présentation pas encore créée",
      presentationNotCreatedForBoard:
        "Il n’existe pas encore de présentation pour {{board}}",
      presentationCreateDescription:
        "Créez un PowerPoint collaboratif lié exclusivement à ce tableau.",
      presentationManagerRequired:
        "La présentation doit être créée par un gestionnaire du projet.",
      presentationNoBoards: "Ce projet ne contient pas encore de tableaux",
      ...
      presentationImportInvalidFile:
        "Sélectionnez un fichier PowerPoint (.pptx) valide et compatible.",
      ...
      presentationMediaUpload: "Téléverser depuis l’ordinateur",
      presentationMediaLoadError:
        "Impossible de charger cette image. Réessayez.",
      ...
      ganttUnscheduledHint:
        "Sans dates, la tâche restera dans la section « Non planifié ».",
      ...
      ganttImportFromBoards: "Importer depuis les tableaux",
      ganttSearchBoardTasks: "Rechercher des tâches ou des cartes...",
      ganttIncludeCompleted: "Inclure les tâches terminées",
      ganttSourceTasksLoadFailed:
        "Impossible de charger les tâches des tableaux.",
      ganttNoBoardTasksFound: "Aucune tâche de tableau trouvée.",
      ganttOpenLinkedTask: "Ouvrir dans le Gantt",
      ganttSelectedTaskCount_one: "{{count}} tâche sélectionnée",
      ganttSelectedTaskCount_other: "{{count}} tâches sélectionnées",
      ganttAddSelectedTasks: "Ajouter au Gantt",
      ganttSourceTasksImported_one: "{{count}} tâche ajoutée au Gantt",
      ganttSourceTasksImported_other: "{{count}} tâches ajoutées au Gantt",
      ganttAddToGantt: "Ajouter au Gantt",
      ganttTaskAddedFromBoard: "Tâche ajoutée au Gantt",
      ganttTaskAddFailed: "Impossible d’ajouter la tâche au Gantt.",
      ganttFromBoard: "Depuis le tableau",
      ganttEditSourceFieldsInCard:
        "Modifiez le nom, le membre et l’état dans la carte.",
      ganttOpenCard: "Ouvrir la carte",
      ganttNoAssignee: "Aucun membre",
      ganttRemoveLinkedTaskConfirmation:
        "Retirer cette tâche du Gantt ? La tâche de la carte ne sera pas supprimée.",
      ...
      savedFilters_title: "Filtres Enregistrés",
      saveFilter_title: "Enregistrer le Filtre",
      filterName: "Nom du filtre",
      noSavedFilters:
        'Aucun filtre enregistré — créez-en un et cliquez sur "Enregistrer".',

...
const INTERNAL_NOTIFIABLE_TYPES = [Types.MOVE_CARD, Types.ADD_MEMBER_TO_CARD, Types.COMMENT_CREATE, Types.COMMENT_UPDATE, Types.COMMENT_DELETE, Types.ADD_LABEL_TO_CARD, Types.REMOVE_LABEL_FROM_CARD, Types.SET_DUE_DATE];
const EXTERNAL_NOTIFIABLE_TYPES = [
  Types.CREATE_CARD,
  Types.MOVE_CARD,
  Types.COMMENT_CREATE,
  Types.ADD_LABEL_TO_CARD,
  Types.CREATE_TASK,
  Types.ADD_MEMBER_TO_CARD,
  Types.SET_DUE_DATE,
  Types.COMMENT_UPDATE,
  Types.COMPLETE_TASK,
];

...
const { getPreviewFilePath } = getFilePath;
...
describe('Project presentation file path', () => {
  ...
  it('keeps the preview alongside the PPTX version that produced it', () => {
    expect(getPreviewFilePath('presentation-1', 'presentation-2.pptx')).to.equal(
      'private/attachments/project-presentations/presentation-1/preview-presentation-2.jpg',
    );
  });
});

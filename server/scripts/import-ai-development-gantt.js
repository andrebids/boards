...
const SOURCE_ITEMS = [
  ...
  ['Christopher', 'Decor Pipeline', 'Simu Studio', '2026-08-17', '2026-08-21', 'Not started'],
  ['Christopher', 'Finish ruler system', 'Simu Studio', '2026-08-24', '2026-08-28', 'Not started'],
  [
    'Christopher',
    'Make AI videos robust',
    'Simu Studio',
    '2026-08-31',
    '2026-09-04',
    'Not started',
  ],
  ['Christopher', 'Sales Rep homepage', 'Simu Studio', null, null, 'Not started'],
  ['Christopher', 'API to get stock', 'Simu Studio', null, null, 'Not started'],
  ['André', 'Ticket System', 'Misc', null, null, 'Not started'],
  ['André', 'Boards V2', 'Misc', null, null, 'Not started'],
  ['André', 'InDesign plugin', 'Misc', null, null, 'Not started'],
  ['André', 'Logo and Simu project forms', 'Simu Studio', null, null, 'Not started'],
  [
    'Carlos',

...
module.exports.routes = {
  ...
  'POST /api/users/generate-password': 'users/generate-password',
  ...
  'GET /api/project-presentations/:id/preview': 'project-presentations/download-preview',
  ...
  'POST /api/comments/:commentId/reactions': 'comment-reactions/toggle',
